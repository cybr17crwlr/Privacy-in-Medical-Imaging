...
with mirrored_strategy.scope():
    ...
    net = tf.keras.Model(inputs = inputs, outputs = predictions, name=f'effnet.aug.imagenet.{imagesize[0]}.full{total_epochs}')
...
checkpoint_filepath = f'checkpoints/effnet.aug.imagenet.{imagesize[0]}.full{total_epochs}.hdf5'
...
logdir = f"logs/scalars/effnet{imagesize[0]}augbs"
