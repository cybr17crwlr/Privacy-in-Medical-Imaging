...
with mirrored_strategy.scope():
    ...
    net = tf.keras.Model(inputs = inputs, 
                        outputs = predictions, 
                        name=f'effnet.aug.imagenet.{imagesize[0]}.full{total_epochs}.dp{noise_multiplier}')

    ## --------------Privacy Based Optimizer--------------

    optimizer = tensorflow_privacy.DPKerasAdamOptimizer(l2_norm_clip=l2_norm_clip,
...
logdir = f"logs/scalars/effnet{imagesize[0]}augdp"
