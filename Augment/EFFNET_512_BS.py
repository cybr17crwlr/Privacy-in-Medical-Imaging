...
net = tf.keras.Model(inputs = inputs, outputs = predictions, name='effnet.aug.imagenet.512.full100')
...
checkpoint_filepath = 'checkpoints/effnet.aug.imagenet.512.full100'
