...
net = tf.keras.Model(inputs = inputs, outputs = predictions, name='effnet.aug.imagenet.256.ctl20.ft80')
...
checkpoint_filepath = 'checkpoints/effnet.aug.imagenet.256.ctl20.ft80.stage1'
...
checkpoint_filepath = 'checkpoints/effnet.aug.imagenet.256.ctl20.ft80.stage2'
model_checkpoint_callback = tf.keras.callbacks.ModelCheckpoint(
    filepath = checkpoint_filepath,
    save_weights_only = True,
    monitor='val_accuracy',
