...
net = tf.keras.Model(inputs = inputs, outputs = predictions, name='effnet.imagenet.1024.ctl20.ft80')
...
checkpoint_filepath = 'checkpoints/effnet.imagenet.1024.ctl20.ft80.stage1'
...
checkpoint_filepath = 'checkpoints/effnet.imagenet.1024.ctl20.ft80.stage2'
model_checkpoint_callback = tf.keras.callbacks.ModelCheckpoint(
    filepath = checkpoint_filepath,
    save_weights_only = True,
    monitor='val_accuracy',
